...
class GitHubClient:
    ...
    def add_and_commit_file(
        self, owner, repo, path, content, message, branch="main", base_branch="main"
    ):
        """
        ...
        if branch_response.status_code == 404:
            ...
            create_branch_payload = {"ref": f"refs/heads/{branch}", "sha": base_sha}
    ...
    def create_pull_request(
        self, owner, repo, head_branch, base_branch, title, body=None
    ):
        """
